...
export function bindUi() {
  ...
  window.closeHydrationModal = closeHydrationModal;
  ...
  window.addSundayWeekExtra = (...args) => import('../domain/sunday-forecast.js').then(m => m.addSundayWeekExtra(...args));
  ...
  window.selectFormVideoClip = selectFormVideoClip;
  ...
  window.confirmLactateTrackLength = confirmLactateTrackLength;
  ...
  window.submitHydrationLog = submitHydrationLog;
  window.submitSpontaneousEvent = submitSpontaneousEvent;
  window.cancelSpontaneousEvent = cancelSpontaneousEvent;
  ...
  window.swapCoreCircuitExercise = swapCoreCircuitExercise;
  window.saveCoreCircuitFromLog = saveCoreCircuitFromLog;
  window.openLoadCoreCircuitPicker = openLoadCoreCircuitPicker;
